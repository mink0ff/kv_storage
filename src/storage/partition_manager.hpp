...
public:
    ...
    bool Set(size_t idx, const std::string& key, const std::string& value);
    bool Del(size_t idx, const std::string& key);

    void SetNoLog(size_t idx, const std::string& key, const std::string& value);
    void DelNoLog(size_t idx, const std::string& key);
